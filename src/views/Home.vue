  ...
  <div class="home container">
      <div class="header flex">
          <div class="left flex flex-column">
              <h1>Hóa đơn</h1>
              <span>Có 4 tổng số hóa đơn</span>
          </div>
          <div class="right flex">
              <div @click="toggleFilterMenu" class="filter flex" ref="filter">
                  <span>Lọc theo trạng thái<span v-if="filteredInvoice">: {{ filteredInvoice }}</span></span>
                  <img src="@/assets/icon-arrow-down.svg" alt="">
                  <ul v-show="filterMenu" class="filter-menu">
                      <li @click="filteredInvoices">Bản nháp</li>
                      <li @click="filteredInvoices">Đang chờ xử lí</li>
                      <li @click="filteredInvoices">Đã thanh toán</li>
                      <li @click="filteredInvoices">Xóa bộ lọc</li>
                  </ul>
              </div>
...
export default {
  ...
  methods: {
    ...
    filteredInvoices(e) {
       if (e.target.innerText === "Xóa bộ lọc") {
  ...
  computed: {
    ...
    filteredData() {
      return this.invoiceData.filter((invoice) => {
        ...
        if (this.filteredInvoice === "Đang chờ xử lí") {
