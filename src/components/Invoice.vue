<template>
    <router-link class="invoice flex" :to="{ name: 'InvoiceView', params: { invoiceId: invoice.invoiceId } }">
        <div class="left flex">
        ...
        >
            <span v-if="invoice.invoicePaid">Đã thanh toán</span>
            <span v-if="invoice.invoiceDraft">Bản nháp</span>
            <span v-if="invoice.invoicePending">Đang chờ xử lý</span>
        </div>
        <div class="icon">
